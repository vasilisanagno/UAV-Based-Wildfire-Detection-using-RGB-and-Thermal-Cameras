...
#include "msgs/msg/detail/tracked_object__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // label, source
#include "rosidl_runtime_c/string_functions.h"  // label, source

// forward declare type support functions


using _TrackedObject__ros_msg_type = msgs__msg__TrackedObject;
...
static uint32_t _TrackedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msgs__msg__TrackedObject(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs__msg__TrackedObject;
    is_plain =
      (
...
static size_t _TrackedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msgs__msg__TrackedObject(
