...
class Metaclass_TrackedDetections(type):
    """Metaclass of message 'TrackedDetections'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__tracked_detections
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__tracked_detections
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__tracked_detections
            cls._TYPE_SUPPORT = module.type_support_msg__msg__tracked_detections
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__tracked_detections

            from msgs.msg import TrackedObject
...
class TrackedDetections(metaclass=Metaclass_TrackedDetections):
    """Message class 'TrackedDetections'."""
    ...
    _fields_and_field_types = {
        ...
        'tracks': 'sequence<msgs/TrackedObject>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['msgs', 'msg'], 'TrackedObject')),  # noqa: E501
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'tracks' field must be a set or sequence and each value of type 'TrackedObject'"
        self._tracks = value
