...
bool msgs__msg__image_with_gps__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs.msg._image_with_gps.ImageWithGPS", full_classname_dest, 37) == 0);
  }
  msgs__msg__ImageWithGPS * ros_message = _ros_message;
  {  // image
...
{
  /* NOTE(esteve): Call constructor of ImageWithGPS */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs.msg._image_with_gps");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImageWithGPS");
