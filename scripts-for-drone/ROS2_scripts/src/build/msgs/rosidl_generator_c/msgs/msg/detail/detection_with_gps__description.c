  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x7c, 0x9b, 0x61, 0x5e, 0x07, 0xdb, 0x2f, 0x1d,
      0x81, 0x28, 0x7c, 0xf8, 0xee, 0xf1, 0x35, 0x2e,
      0x9b, 0x2d, 0x4b, 0x8c, 0xd9, 0x53, 0x66, 0x4c,
      0x87, 0x9f, 0x55, 0x57, 0xf2, 0xa7, 0x4e, 0xbf,
    }};
  return &hash;
}
...
static char msgs__msg__DetectionWithGPS__TYPE_NAME[] = "msgs/msg/DetectionWithGPS";
...
static char msgs__msg__DetectionWithGPS__FIELD_NAME__header[] = "header";
static char msgs__msg__DetectionWithGPS__FIELD_NAME__labels[] = "labels";
static char msgs__msg__DetectionWithGPS__FIELD_NAME__confidences[] = "confidences";
static char msgs__msg__DetectionWithGPS__FIELD_NAME__boxes[] = "boxes";
static char msgs__msg__DetectionWithGPS__FIELD_NAME__tracking_ids[] = "tracking_ids";
static char msgs__msg__DetectionWithGPS__FIELD_NAME__gps[] = "gps";
static char msgs__msg__DetectionWithGPS__FIELD_NAME__image[] = "image";

static rosidl_runtime_c__type_description__Field msgs__msg__DetectionWithGPS__FIELDS[] = {
  {
    {msgs__msg__DetectionWithGPS__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {msgs__msg__DetectionWithGPS__FIELD_NAME__labels, 6, 6},
    {
  ...
  {
    {msgs__msg__DetectionWithGPS__FIELD_NAME__confidences, 11, 11},
    {
  ...
  {
    {msgs__msg__DetectionWithGPS__FIELD_NAME__boxes, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {msgs__msg__DetectionWithGPS__FIELD_NAME__tracking_ids, 12, 12},
    {
  ...
  {
    {msgs__msg__DetectionWithGPS__FIELD_NAME__gps, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {msgs__msg__DetectionWithGPS__FIELD_NAME__image, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription msgs__msg__DetectionWithGPS__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {msgs__msg__DetectionWithGPS__TYPE_NAME, 25, 25},
      {msgs__msg__DetectionWithGPS__FIELDS, 7, 7},
    },
    {msgs__msg__DetectionWithGPS__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "string[] labels\n"
  "float32[] confidences\n"
  "float32[] boxes  # Format: [x1, y1, x2, y2, x1, y1, x2, y2, ...]\n"
  "int32[] tracking_ids\n"
...
msgs__msg__DetectionWithGPS__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *msgs__msg__DetectionWithGPS__get_individual_type_description_source(NULL),
