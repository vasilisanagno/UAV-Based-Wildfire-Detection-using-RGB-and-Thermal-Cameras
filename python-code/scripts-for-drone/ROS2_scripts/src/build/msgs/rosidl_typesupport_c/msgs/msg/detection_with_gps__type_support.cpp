...
static const _DetectionWithGPS_type_support_symbol_names_t _DetectionWithGPS_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs, msg, DetectionWithGPS)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msgs, msg, DetectionWithGPS)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, msgs, msg, DetectionWithGPS)() {
  return &::msgs::msg::rosidl_typesupport_c::DetectionWithGPS_message_type_support_handle;
}
