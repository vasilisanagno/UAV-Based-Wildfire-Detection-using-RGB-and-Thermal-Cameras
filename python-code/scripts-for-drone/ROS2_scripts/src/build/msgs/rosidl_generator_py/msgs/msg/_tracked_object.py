...
class TrackedObject(metaclass=Metaclass_TrackedObject):
    ...
    def __init__(self, **kwargs):
        ...
        if 'box' not in kwargs:
            self.box = numpy.zeros(4, dtype=numpy.float32)
        else:
            self.box = numpy.array(kwargs.get('box'), dtype=numpy.float32)
        ...
        if self._check_fields:
            if isinstance(value, numpy.ndarray):
                assert value.dtype == numpy.float32, \
                    "The 'box' numpy.ndarray() must have the dtype of 'numpy.float32'"
                assert value.size == 4, \
            ...
            assert \
                ...
                "The 'box' field must be a set or sequence with length 4 and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
        self._box = numpy.array(value, dtype=numpy.float32)
