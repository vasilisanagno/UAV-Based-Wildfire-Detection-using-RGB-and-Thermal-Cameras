  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xf2, 0xff, 0xa0, 0x86, 0x40, 0x22, 0x57, 0x63,
      0x21, 0xf9, 0x28, 0x5f, 0x35, 0xaa, 0x2b, 0xa0,
      0x14, 0x5c, 0xca, 0xb6, 0xb9, 0xaf, 0xa1, 0x7b,
      0x30, 0x7e, 0xdf, 0xf9, 0x18, 0x80, 0x5e, 0xf9,
    }};
  return &hash;
}
...
static char msgs__msg__SensorData__TYPE_NAME[] = "msgs/msg/SensorData";
...
static char msgs__msg__SensorData__FIELD_NAME__rgb_image[] = "rgb_image";
static char msgs__msg__SensorData__FIELD_NAME__thermal_image[] = "thermal_image";
static char msgs__msg__SensorData__FIELD_NAME__gps[] = "gps";

static rosidl_runtime_c__type_description__Field msgs__msg__SensorData__FIELDS[] = {
  {
    {msgs__msg__SensorData__FIELD_NAME__rgb_image, 9, 9},
    {
  ...
  {
    {msgs__msg__SensorData__FIELD_NAME__thermal_image, 13, 13},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {msgs__msg__SensorData__FIELD_NAME__gps, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription msgs__msg__SensorData__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {msgs__msg__SensorData__TYPE_NAME, 19, 19},
      {msgs__msg__SensorData__FIELDS, 3, 3},
    },
    {msgs__msg__SensorData__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *msgs__msg__SensorData__get_individual_type_description_source(NULL),
