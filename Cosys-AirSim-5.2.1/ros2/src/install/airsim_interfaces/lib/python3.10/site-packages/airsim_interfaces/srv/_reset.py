...
class Reset_Event(metaclass=Metaclass_Reset_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<airsim_interfaces/Reset_Request, 1>',
        'response': 'sequence<airsim_interfaces/Reset_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['airsim_interfaces', 'srv'], 'Reset_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['airsim_interfaces', 'srv'], 'Reset_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from airsim_interfaces.srv import Reset_Request
    ...
    def response(self, value):
        if self._check_fields:
            from airsim_interfaces.srv import Reset_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Reset(metaclass=Metaclass_Reset):
    ...
    from airsim_interfaces.srv._reset import Reset_Event as Event
