...
class Land_Event(metaclass=Metaclass_Land_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<airsim_interfaces/Land_Request, 1>',
        'response': 'sequence<airsim_interfaces/Land_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['airsim_interfaces', 'srv'], 'Land_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['airsim_interfaces', 'srv'], 'Land_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from airsim_interfaces.srv import Land_Request
    ...
    def response(self, value):
        if self._check_fields:
            from airsim_interfaces.srv import Land_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Land(metaclass=Metaclass_Land):
    ...
    from airsim_interfaces.srv._land import Land_Event as Event
