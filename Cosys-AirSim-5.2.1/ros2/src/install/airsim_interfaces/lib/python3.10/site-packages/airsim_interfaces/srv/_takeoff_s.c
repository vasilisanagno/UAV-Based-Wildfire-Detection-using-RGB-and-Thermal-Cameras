...
ROSIDL_GENERATOR_C_EXPORT
bool airsim_interfaces__srv__takeoff__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("airsim_interfaces.srv._takeoff.Takeoff_Event", full_classname_dest, 44) == 0);
  }
  airsim_interfaces__srv__Takeoff_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!airsim_interfaces__srv__Takeoff_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create airsim_interfaces__srv__Takeoff_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    airsim_interfaces__srv__Takeoff_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!airsim_interfaces__srv__takeoff__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!airsim_interfaces__srv__Takeoff_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create airsim_interfaces__srv__Takeoff_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    airsim_interfaces__srv__Takeoff_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!airsim_interfaces__srv__takeoff__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * airsim_interfaces__srv__takeoff__event__convert_to_py(void * raw_ros_message)
{
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = airsim_interfaces__srv__takeoff__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = airsim_interfaces__srv__takeoff__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
