...
bool airsim_interfaces__msg__instance_segmentation_label__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("airsim_interfaces.msg._instance_segmentation_label.InstanceSegmentationLabel", full_classname_dest, 76) == 0);
  }
  airsim_interfaces__msg__InstanceSegmentationLabel * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of InstanceSegmentationLabel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("airsim_interfaces.msg._instance_segmentation_label");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InstanceSegmentationLabel");
