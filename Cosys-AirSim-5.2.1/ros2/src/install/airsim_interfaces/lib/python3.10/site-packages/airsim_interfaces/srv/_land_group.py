...
class Metaclass_LandGroup_Event(type):
    """Metaclass of message 'LandGroup_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__land_group__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__land_group__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__land_group__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__land_group__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__land_group__event
...
class LandGroup_Event(metaclass=Metaclass_LandGroup_Event):
    """Message class 'LandGroup_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<airsim_interfaces/LandGroup_Request, 1>',
        'response': 'sequence<airsim_interfaces/LandGroup_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['airsim_interfaces', 'srv'], 'LandGroup_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['airsim_interfaces', 'srv'], 'LandGroup_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from airsim_interfaces.srv import LandGroup_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, LandGroup_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'LandGroup_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from airsim_interfaces.srv import LandGroup_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, LandGroup_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'LandGroup_Response'"
...
class Metaclass_LandGroup(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _land_group.Metaclass_LandGroup_Event._TYPE_SUPPORT is None:
                _land_group.Metaclass_LandGroup_Event.__import_type_support__()
...
class LandGroup(metaclass=Metaclass_LandGroup):
    ...
    from airsim_interfaces.srv._land_group import LandGroup_Event as Event
