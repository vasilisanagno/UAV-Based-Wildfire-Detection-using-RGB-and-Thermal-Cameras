...
bool airsim_interfaces__msg__object_transforms_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("airsim_interfaces.msg._object_transforms_list.ObjectTransformsList", full_classname_dest, 66) == 0);
  }
  airsim_interfaces__msg__ObjectTransformsList * ros_message = _ros_message;
  {  // header
  ...
  {  // objects
    ...
    if (!geometry_msgs__msg__TransformStamped__Sequence__init(&(ros_message->objects), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create geometry_msgs__msg__TransformStamped__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    geometry_msgs__msg__TransformStamped * dest = ros_message->objects.data;
...
{
  /* NOTE(esteve): Call constructor of ObjectTransformsList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("airsim_interfaces.msg._object_transforms_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectTransformsList");
