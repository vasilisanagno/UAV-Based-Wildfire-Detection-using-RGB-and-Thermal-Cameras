...
bool airsim_interfaces__msg__computer_vision_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("airsim_interfaces.msg._computer_vision_state.ComputerVisionState", full_classname_dest, 64) == 0);
  }
  airsim_interfaces__msg__ComputerVisionState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ComputerVisionState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("airsim_interfaces.msg._computer_vision_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ComputerVisionState");
