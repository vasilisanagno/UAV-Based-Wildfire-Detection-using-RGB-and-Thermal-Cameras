...
class Metaclass_RefreshInstanceSegmentation_Event(type):
    """Metaclass of message 'RefreshInstanceSegmentation_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__refresh_instance_segmentation__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__refresh_instance_segmentation__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__refresh_instance_segmentation__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__refresh_instance_segmentation__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__refresh_instance_segmentation__event
...
class RefreshInstanceSegmentation_Event(metaclass=Metaclass_RefreshInstanceSegmentation_Event):
    """Message class 'RefreshInstanceSegmentation_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<airsim_interfaces/RefreshInstanceSegmentation_Request, 1>',
        'response': 'sequence<airsim_interfaces/RefreshInstanceSegmentation_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['airsim_interfaces', 'srv'], 'RefreshInstanceSegmentation_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['airsim_interfaces', 'srv'], 'RefreshInstanceSegmentation_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from airsim_interfaces.srv import RefreshInstanceSegmentation_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, RefreshInstanceSegmentation_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'RefreshInstanceSegmentation_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from airsim_interfaces.srv import RefreshInstanceSegmentation_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, RefreshInstanceSegmentation_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'RefreshInstanceSegmentation_Response'"
...
class Metaclass_RefreshInstanceSegmentation(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _refresh_instance_segmentation.Metaclass_RefreshInstanceSegmentation_Event._TYPE_SUPPORT is None:
                _refresh_instance_segmentation.Metaclass_RefreshInstanceSegmentation_Event.__import_type_support__()
...
class RefreshInstanceSegmentation(metaclass=Metaclass_RefreshInstanceSegmentation):
    ...
    from airsim_interfaces.srv._refresh_instance_segmentation import RefreshInstanceSegmentation_Event as Event
