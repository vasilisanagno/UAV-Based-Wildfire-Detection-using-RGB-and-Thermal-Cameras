...
airsim_interfaces__msg__GimbalAngleEulerCmd__create()
{
  ...
  airsim_interfaces__msg__GimbalAngleEulerCmd * msg = (airsim_interfaces__msg__GimbalAngleEulerCmd *)allocator.allocate(sizeof(airsim_interfaces__msg__GimbalAngleEulerCmd), allocator.state);
  if (!msg) {
    return NULL;
  }
...
airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence__init(airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (airsim_interfaces__msg__GimbalAngleEulerCmd *)allocator.zero_allocate(size, sizeof(airsim_interfaces__msg__GimbalAngleEulerCmd), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence * array = (airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence *)allocator.allocate(sizeof(airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence__are_equal(const airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence * lhs, const airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!airsim_interfaces__msg__GimbalAngleEulerCmd__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(airsim_interfaces__msg__GimbalAngleEulerCmd);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    airsim_interfaces__msg__GimbalAngleEulerCmd * data =
      (airsim_interfaces__msg__GimbalAngleEulerCmd *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!airsim_interfaces__msg__GimbalAngleEulerCmd__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          airsim_interfaces__msg__GimbalAngleEulerCmd__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!airsim_interfaces__msg__GimbalAngleEulerCmd__copy(
