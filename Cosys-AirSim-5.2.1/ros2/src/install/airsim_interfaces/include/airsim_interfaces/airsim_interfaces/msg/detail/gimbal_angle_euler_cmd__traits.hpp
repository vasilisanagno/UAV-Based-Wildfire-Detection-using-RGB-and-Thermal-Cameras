...
inline std::string to_yaml(const GimbalAngleEulerCmd & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const airsim_interfaces::msg::GimbalAngleEulerCmd & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const airsim_interfaces::msg::GimbalAngleEulerCmd & msg)
{
