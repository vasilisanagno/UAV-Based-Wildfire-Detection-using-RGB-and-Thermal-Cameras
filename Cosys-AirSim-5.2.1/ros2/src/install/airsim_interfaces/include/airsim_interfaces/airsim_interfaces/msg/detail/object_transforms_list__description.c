  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x28, 0xfc, 0x82, 0xa7, 0xe5, 0x61, 0x88, 0xb6,
      0x1d, 0x64, 0xa3, 0x03, 0xef, 0xfd, 0x4d, 0xe4,
      0x6b, 0xbb, 0x91, 0x9e, 0xfc, 0x4d, 0x3c, 0xaa,
      0x9c, 0x83, 0xe8, 0xfd, 0x86, 0x17, 0x6e, 0xed,
    }};
  return &hash;
}
...
static char airsim_interfaces__msg__ObjectTransformsList__TYPE_NAME[] = "airsim_interfaces/msg/ObjectTransformsList";
...
static char airsim_interfaces__msg__ObjectTransformsList__FIELD_NAME__header[] = "header";
static char airsim_interfaces__msg__ObjectTransformsList__FIELD_NAME__objects[] = "objects";

static rosidl_runtime_c__type_description__Field airsim_interfaces__msg__ObjectTransformsList__FIELDS[] = {
  {
    {airsim_interfaces__msg__ObjectTransformsList__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {airsim_interfaces__msg__ObjectTransformsList__FIELD_NAME__objects, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription airsim_interfaces__msg__ObjectTransformsList__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {airsim_interfaces__msg__ObjectTransformsList__TYPE_NAME, 42, 42},
      {airsim_interfaces__msg__ObjectTransformsList__FIELDS, 2, 2},
    },
    {airsim_interfaces__msg__ObjectTransformsList__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
airsim_interfaces__msg__ObjectTransformsList__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *airsim_interfaces__msg__ObjectTransformsList__get_individual_type_description_source(NULL),
