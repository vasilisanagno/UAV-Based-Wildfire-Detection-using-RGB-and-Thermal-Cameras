...
[[deprecated("use airsim_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const airsim_interfaces::srv::Takeoff_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  airsim_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use airsim_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const airsim_interfaces::srv::Takeoff_Event & msg)
{
  return airsim_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<airsim_interfaces::srv::Takeoff_Event>()
{
  return "airsim_interfaces::srv::Takeoff_Event";
}

template<>
inline const char * name<airsim_interfaces::srv::Takeoff_Event>()
{
  return "airsim_interfaces/srv/Takeoff_Event";
}

template<>
struct has_fixed_size<airsim_interfaces::srv::Takeoff_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<airsim_interfaces::srv::Takeoff_Event>
  : std::integral_constant<bool, has_bounded_size<airsim_interfaces::srv::Takeoff_Request>::value && has_bounded_size<airsim_interfaces::srv::Takeoff_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<airsim_interfaces::srv::Takeoff_Event>
  : std::true_type {};
