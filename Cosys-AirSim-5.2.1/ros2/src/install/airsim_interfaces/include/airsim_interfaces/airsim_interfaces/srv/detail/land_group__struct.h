...
enum
{
  airsim_interfaces__srv__LandGroup_Event__request__MAX_SIZE = 1
};
// response
enum
{
  airsim_interfaces__srv__LandGroup_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/LandGroup in the package airsim_interfaces.
typedef struct airsim_interfaces__srv__LandGroup_Event
{
  service_msgs__msg__ServiceEventInfo info;
  airsim_interfaces__srv__LandGroup_Request__Sequence request;
  airsim_interfaces__srv__LandGroup_Response__Sequence response;
} airsim_interfaces__srv__LandGroup_Event;

// Struct for a sequence of airsim_interfaces__srv__LandGroup_Event.
typedef struct airsim_interfaces__srv__LandGroup_Event__Sequence
{
