...
class Init_SetGPSPosition_Event_response
{
public:
  explicit Init_SetGPSPosition_Event_response(::airsim_interfaces::srv::SetGPSPosition_Event & msg)
  : msg_(msg)
  {}
  ::airsim_interfaces::srv::SetGPSPosition_Event response(::airsim_interfaces::srv::SetGPSPosition_Event::_response_type arg)
  {
...
private:
  ::airsim_interfaces::srv::SetGPSPosition_Event msg_;
};

class Init_SetGPSPosition_Event_request
{
public:
  explicit Init_SetGPSPosition_Event_request(::airsim_interfaces::srv::SetGPSPosition_Event & msg)
  : msg_(msg)
  {}
  Init_SetGPSPosition_Event_response request(::airsim_interfaces::srv::SetGPSPosition_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetGPSPosition_Event_response(msg_);
  }
...
class Init_SetGPSPosition_Event_info
{
public:
  Init_SetGPSPosition_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetGPSPosition_Event_request info(::airsim_interfaces::srv::SetGPSPosition_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetGPSPosition_Event_request(msg_);
  }
...
template<>
inline
auto build<::airsim_interfaces::srv::SetGPSPosition_Event>()
{
  return airsim_interfaces::srv::builder::Init_SetGPSPosition_Event_info();
}
