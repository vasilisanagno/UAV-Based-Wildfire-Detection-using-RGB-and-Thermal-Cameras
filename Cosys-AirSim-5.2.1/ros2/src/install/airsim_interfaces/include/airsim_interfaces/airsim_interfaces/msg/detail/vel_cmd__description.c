...
static char airsim_interfaces__msg__VelCmd__FIELD_NAME__twist[] = "twist";

static rosidl_runtime_c__type_description__Field airsim_interfaces__msg__VelCmd__FIELDS[] = {
  {
    {airsim_interfaces__msg__VelCmd__FIELD_NAME__twist, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription airsim_interfaces__msg__VelCmd__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {geometry_msgs__msg__Twist__TYPE_NAME, 23, 23},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {airsim_interfaces__msg__VelCmd__FIELDS, 1, 1},
    },
    {airsim_interfaces__msg__VelCmd__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *airsim_interfaces__msg__VelCmd__get_individual_type_description_source(NULL),
