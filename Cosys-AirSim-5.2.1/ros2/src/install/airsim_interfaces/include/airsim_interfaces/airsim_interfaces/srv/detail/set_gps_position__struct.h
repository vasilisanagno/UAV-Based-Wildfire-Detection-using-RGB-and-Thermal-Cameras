...
enum
{
  airsim_interfaces__srv__SetGPSPosition_Event__request__MAX_SIZE = 1
};
// response
enum
{
  airsim_interfaces__srv__SetGPSPosition_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetGPSPosition in the package airsim_interfaces.
typedef struct airsim_interfaces__srv__SetGPSPosition_Event
{
  service_msgs__msg__ServiceEventInfo info;
  airsim_interfaces__srv__SetGPSPosition_Request__Sequence request;
  airsim_interfaces__srv__SetGPSPosition_Response__Sequence response;
} airsim_interfaces__srv__SetGPSPosition_Event;

// Struct for a sequence of airsim_interfaces__srv__SetGPSPosition_Event.
typedef struct airsim_interfaces__srv__SetGPSPosition_Event__Sequence
{
