...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_airsim_interfaces
cdr_serialize(
  const airsim_interfaces::srv::TakeoffGroup_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  airsim_interfaces::srv::TakeoffGroup_Event & ros_message);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_airsim_interfaces
max_serialized_size_TakeoffGroup_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_airsim_interfaces
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, airsim_interfaces, srv, TakeoffGroup_Event)();
